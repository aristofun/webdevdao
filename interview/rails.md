...
Вопросы:
 ...
 47. Какие еще циклы Вы знаете? (next, redo, break, downto, upto, step, until, for * in *, keep_if, delete_if)
...
Вопросы:
 ...
 13. Что такое толстые модели и тонкие контроллеры?
 14. Что лучше: толстые модели и тонкие контроллеры либо толстые контроллеры и тонкие модели? Аргументировать.
 15. Что такое Monkeypatching?
 16. Что такое KISS, DRY, SOLID, YAGNI?
 ...
 * https://www.codecademy.com/learn/learn-sql
 ...
 8. На каких инструментах играете, изучаете что-то связанное с музыкой, можете что-то сыграть?
