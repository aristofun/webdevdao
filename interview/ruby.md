...
1. Объясните почему происходит следующее `1660 / 100 ≠ 16.6` (в контексте языка Ruby)
...
1. Объясните почему происходит следующее `24.0 * 0.1 ≠ 2.4` (в контексте языка Ruby)
    <details>
      <summary>Ответ</summary>
